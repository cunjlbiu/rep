        ...
        <div>
            <div className={"max-w-screen-xl mx-auto flex flex-row my-12 justify-evenly  md:flex-col md:mx-5 "}>
                <div className={""}>
                    ...
                    <h3 className={"md:text-[32] md:leading-[40px] md:font-semibold"}
                        dangerouslySetInnerHTML={renderHTML(fields.title)}></h3>
                </div>
                <div className={"b1 w-[640px] md:min-w-[335px] md:w-full md:text-[16px] md:leading-[24px] py-[24px]"}
                ...
                {/*    " border-primary-blue border-2 text-primary-blue"}*/}
                {/*   href={fields.mobileButtonLink ? fields.mobileButtonLink.href : ""}>*/}
                {/*    <p className={"mx-auto md:text-[14px]"}>{fields.mobileButtonLink ? fields.mobileButtonLink.text : ""}</p>*/}
                {/*</a>*/}
            </div>
        </div>
