            ...
            <div className={"max-w-screen-xl mx-auto"}>
                <div className={"flex justify-evenly"}>
                    <div className={"flex flex-col space-y-3"}>
                        ...
                        <a href={fields.buttonLeft.href} className={"self-center"}>
                    ...
                    <div className={"flex flex-col space-y-3"}>
                        ...
                        <a href={fields.buttonCenter.href} className={"self-center"}>
                            <div className={"bttn1 bg-primary-blue hover:bg-primary-darkblue active:bg-primary-blue " +
                                "self-center cursor-pointer rounded-full h-10 w-32 py-1 text-center text-white"}>
                                Buy Now
                            </div>
                    ...
                    <div className={"flex flex-col space-y-3"}>
                        ...
                        <a href={fields.buttonRight.href} className={"self-center"}>
                            <div className={"bttn1 bg-primary-blue hover:bg-primary-darkblue active:bg-primary-blue " +
                                "self-center cursor-pointer rounded-full h-10 w-32 py-1 text-center text-white"}>
                                Buy Now
                            </div>
