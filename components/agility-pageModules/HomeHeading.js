        ...
        <div style={{backgroundColor: fields.bgColor}}>
            <div className={"max-w-screen-xl md:mx-{20px} md:content-center flex m-auto flex-row my-8 md:flex-col"}>
                <div className={"lg:w-6/12 md:w-full md:justify-center md:items-center"}>
                    ...
                    <div className={"md:min-w-[335px] md:w-full"}>
                    ...
                    <div className={"flex flex-row items-center space-x-4 my-6 md:ml-5 md:justify-center"}>
                        <a className={"flex bttn1 w-36 h-12 items-center bg-primary-blue rounded-full"}><p className={"mx-auto text-primary-white md:text-[14px]"}>Create course</p></a>
                        <a className={"flex bttn1 w-36 h-12 items-center border-primary-blue rounded-full border-primary-blue border-2 text-primary-blue"}><p className={"mx-auto md:text-[14px]"}>Find a Course</p></a>
                    </div>
                </div>
                <div className={"lg:w-6/12 md:w-full md:justify-center md:items-center"}>
