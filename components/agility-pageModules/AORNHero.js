    ...
    return(
        <div style={{backgroundColor: fields.bgColor}} className={"lg:h-[1600px] md:mt-[90px] "}>
            <div className={"lg:max-w-screen-xl mx-auto lg:flex lg:flex-row my-8 md:mx-5 md:mb-[30px]"}>
                ...
                <div className={"flex justify-evenly mt-3 lg:hidden"}>
                    <a className={"text-white w-[157px] h-[48px] rounded-full text-primary-blue hover:bg-primary-blue hover:text-white active:scale-90 border-2 border-primary-blue text-center py-1 self-center"}><span className={"bttn1"}>Log in</span></a>
                    <a className={"bttn1 text-white w-[157px] h-[48px] rounded-full bg-primary-blue text-center py-2 self-center"}>Sign up</a>
                </div>
            ...
            <div className={"bg-soft-green md:pb-10"}>
                <div className={"max-w-screen-xl mx-auto md:mx-5"}>
                    <div className={"mx-auto bg-primary-white rounded-xl border-2 md:max-w-[700px] border-soft-green -translate-y-1/2 lg:py-16 lg:px-32 text-center mt-28 md:-mb-32 mdplus:-mb-12"}>
